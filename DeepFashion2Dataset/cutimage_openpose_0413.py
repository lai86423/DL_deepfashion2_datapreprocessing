...
# train_x_file = base_path + '/train/train_top_dir_file.txt'
# train_y_file = base_path + '/train/train_top_label_file.txt'
# val_x_file = base_path + '/validation/val_x_file_up.txt'
# val_y_file = base_path + '/validation/val_y_file_up.txt'

#train_x_file_v413 -->去除沒有人或人多或角度不正常
# new_tra_x_file = open(base_path + '/train/train_x_file_v413.txt',"a")
# new_tra_y_file = open(base_path + '/train/train_y_file_v413.txt',"a")
# new_val_x_file = open(base_path + '/train/train_x_file_v413.txt',"a")
# new_val_y_file = open(base_path + '/train/train_y_file_v413.txt',"a")
...
try:
    ...
    for i in range(len(train_x_file)):
        print("--------", train_x_file[i], train_y_file[i])
        openpose_preprocess(train_x_file[i], train_y_file[i],str(i+1).zfill(6), new_img_dir, train_x_file, train_y_file)   
